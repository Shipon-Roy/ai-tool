  ...
  return (
    <footer className="relative z-10 pb-[4.375rem] lg:pb-[5.625rem] xl:pb-[6.875rem]">
      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 relative pt-[4.375rem]">
        <div className="w-full h-[1px] bg-gradient-to-r from-purple-500 to-pink-500 absolute top-0 left-0"></div>

        <div className="flex flex-wrap justify-between">
          {/* Logo & Description */}
          <div className="mb-10 max-w-[571px] w-full">
            <Link className="mb-8 inline-block" href="index.html">
              <h1 className="text-2xl font-bold">AI Tool</h1>
            </Link>
            <p className="mb-12 xl:w-4/5 text-gray-400">
            ...
            <p className="font-medium mt-[1.375rem] text-gray-400">
                ...
                <ul className="flex flex-col gap-3.5">
                  {[
                    ...
                    <li key={item}>
                      <Link
                        href="/#"
                        className="font-medium ease-in duration-300 hover:text-white text-gray-400"
                      >
                        {item}
                      </Link>
                    </li>
